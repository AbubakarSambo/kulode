...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Inventory', href: '/inventory', icon: InventoryIcon, requiresPlan: 'PRO' as PlanTier },
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#0037b0] to-[#1d4ed8] flex items-center justify-center font-bold text-white text-sm shadow-md shadow-[#0037b0]/25 shrink-0">
              K
            </div>
            <span className={cn(
              "text-xl font-bold tracking-tighter text-slate-900 transition-all duration-200",
