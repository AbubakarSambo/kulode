          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <h1 className="text-xl font-extrabold text-[#0037b0] tracking-tight leading-tight truncate">
            ...
            <div className="flex items-center gap-2 shrink-0 flex-wrap">
              ...
              {invoice.paymentUrl && !isPaid && !hasInstallments && (
                <button
                  ...
                  disabled={isPaying}
                  className="inline-flex items-center gap-1.5 h-9 px-4 rounded-lg text-xs font-extrabold text-white cursor-pointer transition-all disabled:opacity-60"
          ...
          >
            ...
            {isPaid ? (
              <>
                ...
                <p className="text-4xl font-black text-[#006c49] tracking-tight mt-1">
              ...
              <>
                ...
                <p className={`text-4xl font-black tracking-tight mt-1 ${invoice.status === 'OVERDUE' ? 'text-rose-700' : 'text-[#0037b0]'}`}>
                  {formatCurrency(
          ...
          <div className="bg-white rounded-2xl border border-slate-200/60 overflow-hidden" style={{ boxShadow: '0px 8px 24px rgba(0,55,176,0.05)' }}>
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-extrabold text-[#121c28]">Invoice Details</span>
              </div>
              <span
            ...
            <div className="px-5 py-5 space-y-5">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <p className="font-extrabold text-[#121c28] text-sm leading-tight">{invoice.client.name}</p>
              ...
              <div className="space-y-1.5 pt-1">
                ...
                <div className="flex justify-between items-center pt-2 border-t border-slate-100 mt-2">
                  <span className="text-sm font-extrabold text-[#121c28]">Total</span>
                  <span className="text-lg font-black text-[#121c28] tabular-nums">{formatCurrency(invoice.total)}</span>
                </div>
                ...
                {invoice.amountPaid > 0 && (
                  <>
                    ...
                    <div className="flex justify-between items-center pt-1.5 border-t border-dashed border-slate-200">
                      ...
                      <span className={`text-base font-black tabular-nums ${outstanding <= 0 ? 'text-[#006c49]' : 'text-[#0037b0]'}`}>
                ...
                {invoice.installments.map((inst) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-extrabold text-[#121c28]">{inst.label}</p>
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-3">
                      <span className="text-sm font-black text-[#121c28] tabular-nums">
                      ...
                      {inst.isPaid ? (
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            disabled={isPaying}
                            className="inline-flex items-center gap-1.5 h-9 px-3 rounded-lg text-[11px] font-bold text-white cursor-pointer transition-all disabled:opacity-60"
                            style={{ background: 'linear-gradient(135deg, #0037b0 0%, #1d4ed8 100%)' }}
                          >
                            <HugeiconsIcon icon={CreditCardIcon} className="h-3.5 w-3.5" />
                            Pay Instalment
          ...
          {invoice.organization.bankAccountNumber && !isPaid && (
            <div className="bg-white rounded-2xl border border-slate-200/60 overflow-hidden" style={{ boxShadow: '0px 8px 24px rgba(0,55,176,0.05)' }}>
              <div className="flex items-center gap-2 px-5 py-4 border-b border-slate-100">
                ...
                <span className="text-sm font-extrabold text-[#121c28]">Direct Bank Transfer</span>
              </div>
              <div className="p-5 space-y-4">
                ...
                <div className="rounded-xl bg-[#f8f9ff] border border-slate-100 overflow-hidden">
                  ...
                  <div className="flex justify-between items-center px-4 py-3 bg-white border-t border-slate-100">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-black text-[#121c28] tabular-nums select-all">
          ...
          {invoice.paymentUrl && !isPaid && !hasInstallments && (
            <div className="text-center">
              <button
                ...
                onClick={() => handlePayNow()}
                disabled={isPaying}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 h-12 px-8 rounded-xl text-sm font-extrabold text-white cursor-pointer transition-all disabled:opacity-60 shadow-[0px_8px_24px_rgba(0,55,176,0.25)]"
                style={{ background: 'linear-gradient(135deg, #0037b0 0%, #1d4ed8 100%)' }}
              >
