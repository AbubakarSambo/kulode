  ...
  async update(id: string, dto: UpdateOrganizationDto) {
    ...
    const updated = await this.prisma.organization.update({
      ...
      data: {
        ...
        ...(typeof dto.entertainmentTaxRate === 'number' && { entertainmentTaxRate: dto.entertainmentTaxRate }),
        ...(typeof dto.entertainmentTaxEnabled === 'boolean' && { entertainmentTaxEnabled: dto.entertainmentTaxEnabled }),
        ...(typeof dto.serviceChargeRate === 'number' && { serviceChargeRate: dto.serviceChargeRate }),
        ...(typeof dto.serviceChargeEnabled === 'boolean' && { serviceChargeEnabled: dto.serviceChargeEnabled }),
        ...(typeof dto.showQrCode === 'boolean' && { showQrCode: dto.showQrCode }),
        ...(dto.shiftStartTime !== undefined && { shiftStartTime: dto.shiftStartTime }),
        ...(dto.shiftEndTime !== undefined && { shiftEndTime: dto.shiftEndTime }),
